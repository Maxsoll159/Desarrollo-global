            ...
            <article className="container mx-auto">
                <div className="grid grid-cols-2 lg:grid-cols-4 p-5">
                    <div className="flex items-center gap-3 mx-auto">
                        <Image src="/img/IconBeneficio1.webp" alt="Desarrollo Global - Certificacion Universitaria" width={100} height={104} className="w-[40px] md:w-auto" />
                        <div>
                            <p className="text-sm md:text-2xl font-bold text-blue-desarrollo">ISO 9001-2015</p>
                    ...
                    <div className="flex items-center gap-3 mx-auto">
                        ...
                        <div>
                            <p className="text-sm md:text-2xl font-bold text-blue-desarrollo">FCE-UNMSM</p>
                    ...
                    <div className="flex items-center gap-3 mx-auto">
                        ...
                        <div>
                            <p className="text-sm md:text-2xl font-bold text-blue-desarrollo">Mas de 50, 000</p>
                    ...
                    <div className="flex items-center gap-3 mx-auto">
                        ...
                        <div>
                            <p className="text-sm md:text-2xl font-bold text-blue-desarrollo">Más de 12 años</p>

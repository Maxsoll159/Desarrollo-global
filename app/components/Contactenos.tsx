    ...
    return (
        <>
            ...
            <section className="bg-[#18248a] md:bg-white">
                <article className="container mx-auto flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-5 p-5">
                    <div className="bg-white w-full md:w-[48%] h-auto lg:w-[446px] md:h-[417px] rounded-sm shadow-md mx-auto p-10 m-0 md:-mt-20">
                        <div className="bg-blue-desarrollo text-white w-[140px] h-[140px] rounded-full mx-auto flex items-center justify-center">
                    ...
                    <div className="bg-white w-full md:w-[48%] h-auto lg:w-[446px] md:h-[417px] rounded-sm shadow-md mx-auto p-10 m-0 md:-mt-20">
                        <div className="bg-blue-desarrollo text-white w-[140px] h-[140px] rounded-full mx-auto flex items-center justify-center">
                            <HiOutlineMail className='text-7xl' />
                        </div>

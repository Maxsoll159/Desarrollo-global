            ...
            <article className="container mx-auto p-5 md:p-0">
                <div className="grid grid-cols-1">
                    <div className="w-full">
                        ...
                        <p className="text-center w-full md:w-1/2 mx-auto mt-10 text-parrajos">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In pellentesque cursus nunc sit amet dignissim. Morbi quis justo ut nibh tincidunt</p>

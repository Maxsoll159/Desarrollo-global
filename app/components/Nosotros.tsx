        ...
        <section className="bg-white py-20">
            <article className="container mx-auto p-5 md:p-0">
                <div className="grid grid-cols-1">
                    <div>
                        <iframe src="https://s3-desarrollo-global.s3.us-west-2.amazonaws.com/pagina-web/desarrolloglobal_info.mp4" width="640" height="360"  allow="autoplay; fullscreen"  className="block mx-auto rounded-md"></iframe>
